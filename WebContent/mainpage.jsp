    ...
    <div class="container">    	
	    <c:forEach var="category" items="${ allCategories }">
		    ...
		    <c:forEach var="row" items="${ rows }">
				    ...
				    <div class="row">	    			   			   			
		  				<c:forEach var="news" items="${ row }">
		   					<div class="col-md-3 col-sm-6">
								...
								<h3><a href="newspage?idnews=${ news.idnews }">${ news.title }</a></h3>
								<p>${ news.annotation }</p>
   			...
   			<div class="row">
   				<p><a href="category?idcategory=${ category.idcategory }" class="btn btn-default" role="button">Xẹm thêm tin cùng chuyên mục &raquo</a></p>
   				<hr>
			</div>		    
	    </c:forEach>
    </div>
