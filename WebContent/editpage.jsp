...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
    	<div class="row">
	    	<form action="newspage" method="post" enctype="multipart/form-data"  accept-charset="utf-8">
	    		<div class="form-group hidden">
	    			<label for="inputTextIdnews">ID </label>
	    		...
	    		<div class="form-group">
	    			...
	    			<input type="text" name="title" class="form-control" id="inputTextTitle" placeholder="Tiêu đề" required value="${ news.title }">
	    		</div>
	    		<div class="form-group">
	    			<label for="selectIdcat">Danh mục</label>
	    		...
	    		<div class="form-group">
	    			...
	    			<textarea name="annotation" class="form-control" id="textareaAnnotation" placeholder="Tóm tắt" rows="3" required>${ news.annotation }</textarea>
	    		</div>
	    		<div class="form-group">
	    			<label for="textMainText">Nội dung</label>
	    			<textarea name="text" class="form-control" id="textareatextMainText" placeholder="Nội dung" rows="12" required>${ news.text }</textarea>
	    		</div>
	    		<div class="form-group">
